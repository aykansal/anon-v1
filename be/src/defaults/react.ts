...
<boltArtifact id="project-import" title="Project Files">
  ...
  <boltAction type="file" filePath="package.json">
    {
      ...
      "dependencies": {
        ...
        "react": "^18.3.1",
        "react-dom": "^18.3.1",
        "arweave-wallet-kit": "^1.0.2",
        "react-router-dom": "^6.22.3",
        "@permaweb/aoconnect": "v0.0.62"
      },
      "devDependencies": {
        "@eslint/js": "^9.9.1",
        "@types/react": "^18.3.5",
  ...
  <boltAction type="file" filePath="src/lua/handler.lua">
    --all lua handlers for arweave will be here
  </boltAction>

  <!-- Creating the new src/styles folder with a sample CSS file -->
  ...
  <!-- Creating the new src/context folder with a sample context file -->
  <boltAction type="file" filePath="src/context/ThemeContext.tsx">
